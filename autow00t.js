...
function initAPIListeners()
{
    ...
    API.addEventListener(API.WAIT_LIST_UPDATE, waitListqueueUpdate);
    API.addEventListener(API.DJ_UPDATE, DJqueueUpdate);
...
function displayUI()
{
    ...
    $('#plugbot-ui').append(
        '<center>' + 
            ...
            '<p id="plugbot-btn-meh" style="color:' + cMeh + '">auto-meh</p>' +
...
function DJqueueUpdate()
{

    queueUpdate();
   
   console(API.getRoomScore());
}

function waitListqueueUpdate()
{
